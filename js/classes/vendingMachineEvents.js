class VendingMachineEvents {
  // constructor() -> index.js에서 생성자함수로 인스턴스를 만들때 실행된다
  constructor() {
    ...
    this.btnPut = vMachine.querySelector('#input-money+.btn'); // #input-money의 btn
  ...
  bindEvent() {
    ...
    this.btnPut.addEventListener('click', () => {
      ...
      // 소지금
      const myMoneyVal = parseInt(this.myMoney.textContent.replaceAll(',', '')); //소지금이 커지면 , 가 늘어나기 때문에 All로 써줌
